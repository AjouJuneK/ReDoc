...
if __name__ == '__main__':
    ...
    #JK
    # text_data_dir = "../../finished_files/"
    # print(config.vocab_size)
    # print(config.max_dec_steps)
    # for idx in range(160000):
    #     print("generating decoded contextdata %i" % idx)
    #     train_data_dir = text_data_dir + "train" + str(idx) + ".bin"
    #     beam_Search_processor = BeamSearch_jk(model_filename, train_data_dir, idx)
    #     beam_Search_processor.decode(idx)
