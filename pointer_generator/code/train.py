# Most of this file is refered from https://github.com/atulkum/pointer_summarizer and https://github.com/abisee/pointer-generator/
...
from data_util.uitls import write_for_rouge, rouge_eval, rouge_log
...
class BeamSearch_jk(object):
    def __init__(self, model_file_path, train_file_path, idx):
        ...
        self.batcher = Batcher(train_file_path, self.vocab, mode='decode',
